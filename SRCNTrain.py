...
csv_logger = CSVLogger('trainingLog1.log')
model_checkpoint = ModelCheckpoint('modelSaved1.h5', monitor='val_loss', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
